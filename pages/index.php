...
<body class="bgimg">
    ...
    <div class="account-container">
        <input type="button" class="account-btn" value="Login" onclick="window.location.href='login.php'">
        <input type="button" class="account-btn" value="Register" onclick="window.location.href='register.php'">
    </div>

    <div class="slider-controls">
        <input type="button" value="<" onclick="shiftCounter(-1)"></input>
        <input type="button" value="Play" onclick="restart()" class="toggled"></input>
