<?php
	...
	include(__DIR__ . "/" . "src/php/queries.php");
	include_once(__DIR__ . "/" . "src/php/functions.php");
	...
	include(__DIR__ . "/" . "src/php/install.php");
